...
class Stats(ttk.Frame):
    def __init__(self,  parent, controller):
        ...
        self.differentialR.grid(row=1, column=1, sticky='w')
        self.relativeR.grid(row=1, column=2, sticky='w')
        self.hartmannR.grid(row=1, column=3, sticky='w')
        self.chronologyR.grid(row=1, column=4, sticky='w')
