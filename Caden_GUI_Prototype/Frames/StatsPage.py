...
class Stats(ttk.Frame):
    def __init__(self,  parent, controller):
        ...
        self.cumulativeR.place(x=-200, y=-340, relx=0.5,
                               rely=0.5, anchor='center')
        self.differentialR.place(x=-100, y=-340, relx=0.5,
                                 rely=0.5, anchor='center')
        self.relativeR.place(x=0, y=-340, relx=0.5, rely=0.5, anchor='center')
